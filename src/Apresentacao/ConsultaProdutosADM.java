 ...
 * @author aluno
 */
public class ConsultaProdutosADM extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaProdutosADM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
