 ...
 * @author aluno
 */
public class ConsultarClienteFUN extends javax.swing.JFrame {
...
if (jTCliente.getSelectedRow() != -1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarClienteFUN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarClienteFUN().setVisible(true);
            }
        });
    }
