 ...
 * @author aluno
 */
public class TeladeAgendamentoAdm extends javax.swing.JFrame {
    String txtID;
 ...
 readJTableForNome(txtBuscarNome.getText());       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeladeAgendamentoAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
